...
<div class="container">
    <center><h1>Users Posts</h1></center>
    <br>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class= "row">
                        ...
                        <div class= "col-s6">
                            {!!Form::open(['action'=>'InformatieController@search', 'method'=> 'POST', 'enctype'=> 'multipart/form-data'])!!}
                        ...
                        <table class ="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td scope="row"><a class="btn btn-primary" href="/informatie/{{$movie->id}}/edit" role="button">Edit</a></td>
                                    <td scope="row">
                                        {!!Form::open(['action'=>['InformatieController@destroy',$movie->id], 'method'=> 'POST', 'class'=>'pull-right'])!!}
